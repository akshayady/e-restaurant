          ...
          <TableHead sx={{backgroundColor:"brown"}}>
            <TableRow>
              <TableCell align="left">
                <Typography variant="h6" color="cornsilk">
                  Order Id
                </Typography>
              </TableCell>
              <TableCell align="left">
              ...
              orders.map((item, index) => {
                return (
                  <TableRow key={index}>
                          ...
                          return (
                            <Paper>
                              <Grid container p={1} key={index} spacing={1}>
                                ...
                                <Grid item xs={7}>
                                  <Typography textAlign="center"  variant="button" gutterBottom>
                                  ...
                                  >
                                    ...
                                    <Typography variant="subtitle2">{item.qnty}</Typography>
                                  </Box>
                    ...
                    <TableCell>&#8377;{item.finalTotal}</TableCell>
